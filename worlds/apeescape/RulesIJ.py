...
def WSW_ThirdRoom(state, world):
    return (HasHoop(state, world) and HasNet(state, world)) or HasSling(state, world) or HasFlyer(state, world)
...
def SF_MechRoom(state, world):
    return HasSling(state, world) or (HasHoop(state, world) and HasFlyer(state, world)) or (HasNet(state, world) and ((HasClub(state, world) and HasRC(state, world)) or HasPunch(state, world))) or SuperFlyer(state, world)
