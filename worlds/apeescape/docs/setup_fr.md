...
7. Pour connecter le client au serveur, entrez l'adresse de la salle et le port (ex. `archipelago.gg:38281`) dans le champ situé en haut du client et appuyez sur Connect.
