...
doorTransitions = {
    ...
    AEDoor.CCAVE_ENTRY.value: {22, 0},
    AEDoor.CCAVE_ENTRY_SECOND_ROOM.value: {22, 2},
    ...
    AEDoor.DI_GALLERY_SLIDE_ROOM_TOP.value: {26, 3},
    ...
    AEDoor.WSW_ENTRY.value: {40, 0},
    AEDoor.WSW_ENTRY_GONG.value: {40, 2},
    AEDoor.WSW_GONG_ENTRY.value: {41, 0},
    AEDoor.WSW_GONG_MIDDLE.value: {41, 2},
    AEDoor.WSW_MIDDLE_GONG.value: {42, 0},
    AEDoor.WSW_MIDDLE_OBSTACLE.value: {42, 2},
    AEDoor.WSW_OBSTACLE_MIDDLE.value: {43, 0},
    AEDoor.WSW_OBSTACLE_BARREL.value: {43, 2},
    AEDoor.WSW_BARREL_OBSTACLE.value: {44, 0},
...
def createLocationGroups():
    ...
    for x in range (0, len(location_table) - 1):
        ...
        if "Specter" in locname or "Boss" in locname or "Rescue" in locname or "Defeat" in locname:
